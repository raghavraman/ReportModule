...
public class VoiceCallMissedActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.voicecall_missed_layout);
