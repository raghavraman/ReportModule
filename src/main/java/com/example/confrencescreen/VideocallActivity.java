...
public class VideocallActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addTab("Dialed",getResources().getDrawable(R.drawable.tab_call_dialedcallicon),	VideoCallDialedActivity.class);
		addTab("Received", getResources().getDrawable(R.drawable.tab_call_receivedcallicon),	VideoCallReceivedActivity.class);
		addTab("Missed",getResources().getDrawable(R.drawable.tab_call_missedcallicon), VideoCallMissedActivity.class);
	}
